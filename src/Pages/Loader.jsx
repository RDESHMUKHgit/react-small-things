...
const Loader = () => {
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-gray-900 dark:bg-gray-900">
      <section className="w-32 h-32 relative flex items-center justify-center">
        {/* Outer glowing pulse */}
        <div className="absolute inset-0 rounded-xl bg-blue-500/20 blur-xl animate-pulse" />

        {/* Spinning gradient + bars */}
        <div className="w-full h-full relative flex items-center justify-center">
          ...
          <div className="absolute inset-1 bg-gray-900 dark:bg-gray-900 rounded-lg flex items-center justify-center overflow-hidden">
